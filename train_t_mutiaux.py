...
def train(epoch, train_loader, model, criterion, optimizer, opt,loggering,device,aux):
    """vanilla training"""
    model.train()
    ...
    for idx, (input, target) in enumerate(train_loader):
        ...
        output = model(input,aux=6)
        # output,out_aux1,out_aux2 = model(input,aux=i)
        # output = model(input,aux=i,epoch=epoch)
...
def parse_option():
    ...
    parser.add_argument('--aux', type=bool, default=True, help='whether use aux')
    ...
    parser.add_argument('--model', type=str, default='mobile_vit_tiny_likevitpp',
                       choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110','ResNet50','ResNet18',
                                 ...
                                 'MobileNetV2','MobileNetV3', 'ShuffleV1', 'ShuffleV2','mobile_vit_tiny','mobile_vit_xx_small_init','mobile_vit_x_small_init',
                                  'mobile_vit_small_init','mobile_vit_tiny_init','mobile_vit_xx_small_in7','mobile_vit_x_small_in7',
                                   ...
                                   'mobile_half_5_1_1_3','mobile_half_class','mobile_half_class_2','mobile_half_class_3','RepTinynet18','RepTinynet19','RepTinynet20','RepTinynet21','RepTinynet22','RepTinynet23','mobile_half_5_1_1_4','RepTinynet24','RepTinynet25','repvggnet','McuNetv1','Mobilenetxtnet','MobilenetV1','mculike','ContrastNet4','ContrastNet5','ContrastNet2','finalNet','mobile_half_aux'])
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        if epoch==1:
            for input,_ in (train_loader):
                ...
                break
        time1 = time.time()
        train_acc, train_loss = train(epoch, train_loader, model, criterion, optimizer, opt,loggering,device,aux=False)
