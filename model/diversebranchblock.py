...
class DiverseBranchBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if deploy:
            ...
            # self.dbb_origin_tower = RepTowerBlock(out_channels,out_channels,expand_rate=2,groups=groups)
            ...
            if groups < out_channels:
                ...
                # self.dbb_1x1_tower = RepTowerBlock(out_channels,out_channels,expand_rate=2,groups=groups)
            else:
                self.dbb_avg.add_module('avg', nn.AvgPool2d(kernel_size=kernel_size, stride=stride, padding=padding))

            self.dbb_avg.add_module('avgbn', nn.BatchNorm2d(out_channels))
            # self.dbb_avg_tower = RepTowerBlock(out_channels,out_channels,expand_rate=2,groups=groups)
            ...
            # self.dbb_1x1_kxk_tower = RepTowerBlock(out_channels,out_channels,expand_rate=2,groups=groups)
    ...
    def forward(self, inputs):
        ...
        return self.nonlinear(out/count)
        # return self.nonlinear(out)

        # if hasattr(self, 'dbb_reparam'):
        #     return self.nonlinear(self.dbb_reparam(inputs))
        # count = 3
        # out = self.dbb_origin_tower(self.dbb_origin(inputs))
        # if hasattr(self, 'dbb_1x1'):
        #     out += self.dbb_1x1_tower(self.dbb_1x1(inputs))
        #     count=count+1
        # out += self.dbb_avg_tower(self.dbb_avg(inputs))
        # out += self.dbb_1x1_kxk_tower(self.dbb_1x1_kxk(inputs))
        # return self.nonlinear(out/count)
